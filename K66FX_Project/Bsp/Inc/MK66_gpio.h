...
extern PORT_Type * const PORTX[] ;
extern GPIO_Type * const GPIOX[] ;
 
 
#define Pin_Set(ptx_n)	    GPIOX[PTX((PTX_n)ptx_n)]->PDOR |= 	  (uint32)(1<<PTn((PTX_n)ptx_n))
#define Pin_Reset(ptx_n)	GPIOX[PTX((PTX_n)ptx_n)]->PDOR &= ~  (uint32)(1<<PTn((PTX_n)ptx_n))
#define Pin_Toggle(ptx_n)	GPIOX[PTX((PTX_n)ptx_n)]->PDOR ^=    (uint32)(1<<PTn((PTX_n)ptx_n))
